...
export const Header =  () => {
    ...
    return (
        ...
        <header>
            <div class="upper-h">
                {/* 1. Title Web */}
                <p class="title">Jastip <span class="blue-t">Stella</span></p>
                {/* 2. SearchBar */}
                <SearchBar />
                {/* 3. Contacts Us */}
            ...
            <div class="category-container">
                <div class="left-categories">
                    <A href="/" end class="category-item">Beranda</A>
                </div>  
                <div class="right-categories">
                    <A href="/kategori/semua" class="category-item">Semua Kategori</A>
                    <A href="/kategori/kosmetik" class="category-item">Kosmetik</A>
                    <A href="/kategori/makanan" class="category-item">Makanan</A>
                    <A href="/kategori/suplementasi" class="category-item">Suplementasi</A>
                    <A href="/kategori/fashion" class="category-item">Fashion</A>
                    <A href="/kategori/others" class="category-item">Others</A>
                </div>
            </div>
        </header>
        </>
