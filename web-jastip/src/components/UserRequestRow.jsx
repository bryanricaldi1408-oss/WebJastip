export const UserRequestRow = (props) => {
    ...
    const approvalClass = () => {
        switch (props.approval_status) {
            case 'approved': return 'ur-badge ur-badge--approved';
            case 'denied': return 'ur-badge ur-badge--denied';
            default: return 'ur-badge ur-badge--pending';
        }
    };
        ...
        <tr class="ur-row">
            ...
            <td>
                <div class="ur-item-info">
                    <a href={props.item_link || '#'} target="_blank" rel="noopener noreferrer" class="ur-item-link">{props.name}</a>
                    <span class="ur-desc">Kategori: {props.category || '-'}. {props.details}</span>
                </div>
            </td>
            <td>
