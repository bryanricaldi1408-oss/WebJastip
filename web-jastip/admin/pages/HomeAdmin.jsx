...
export const HomeAdmin = () => {
  ...
  const handleAddProduct = async (e) => {
      ...
      try{
        ...
        console.log("Add Product:", newProductName(), newProductPrice(), newProductDesc(), newProductImage());
        ...
        <main class="main-content">
          <header class="topbar">
            <div class="topbar-left">
              <button class="hamburger-btn" onClick={() => setSidebarOpen(!sidebarOpen())}>
          ...
          <section class="admin-section">
            <div class="section-header">
              ...
              <button class="btn btn-primary" onClick={() => setIsAddModalOpen(true)}>+ Add New Product</button>
            </div>
            <div class="card">
        ...
        <div class={`modal-overlay ${isAddModalOpen() ? 'active' : ''}`}>
          <div class="modal-content">
            <div class="modal-header">
              ...
              <button class="close-btn" onClick={() => setIsAddModalOpen(false)}>×</button>
            </div>
              ...
              <div class="modal-body">
                ...
                <div class="form-group">
                  ...
                  <div class="image-upload-wrapper">
                    ...
                    />
                    <label for="product-image" class={`image-upload-label ${imagePreview() ? 'has-image' : ''}`}>
